			...
			<div  class="easyui-accordion">
				<div title="" data-options="selected:true">
					<ul class="search-form" style="list-style-type:none">
						<li class="search-form li"><input name="name" class="easyui-textbox" label="图书名称：" labelWidth="100px;"  data-options="prompt:'关键字'" style="width:20%"> </li>
...
<table id="dataGridInbound" title="数据列表" class="easyui-datagrid"></table>
</body>
<script>
	$(function () {
		...
		$("#dataGridInbound").datagrid({
			...
			columns: [[
				...
				{ field: 'id', title: '图书编码', width: '100', align: 'left', sortable: true },
				{ field: 'name', title: '图书名称', width: '100', align: 'left', sortable: true },
				{ field: 'author', title: '作者', width: '100', align: 'left', sortable: true },
				{ field: 'count', title: '库存', width: '100', align: 'left', sortable: true },
				{
					field: 'deal',
					title: '操作',
					align: 'center',
